...
<head>
    ...
    <title>Games in ${genre.getGenreName()} &mdash; Vapor</title>
...
<div class="container">
    <h3 class="title is-3">${genre.getGenreName()} Games</h3>
    <table class="table is-striped is-fullwidth">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="5" style="text-align: center;">No Games under ${genre.getGenreName()}.</td>
                </tr>
            </c:otherwise>
        </c:choose>
        </tbody>
