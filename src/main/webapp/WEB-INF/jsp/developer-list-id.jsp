...
<head>
    ...
    <title>Games by ${developer.getDeveloperName()} &mdash; Vapor</title>
...
<div class="container">
    <h3 class="title is-3">Games by ${developer.getDeveloperName()}</h3>
        ...
        <c:choose>
            <c:when test="${not empty gameList}">
                <c:forEach items="${gameList}" var="gL">
                    <tr>
                        <td>
                            <figure class="image"><img src="${gL.getGameImgLink()}" alt="${gL.getGameName()} image">
                            </figure>
                        </td>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="6" style="text-align: center;">No Games found by ${developer.getDeveloperName()}.</td>
                </tr>
            </c:otherwise>
        </c:choose>
        </tbody>
